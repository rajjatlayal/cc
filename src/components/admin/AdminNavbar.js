      ...
      <div className="container-fluid main_navbar">
          <div className="row" style={{width:"100%",margin:"0"}}>
              <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-6 navbar_left_div">
                  <h4><span className="navbar_toggle" style={{display:"none"}} onClick={changeSidebar}><span className="toggle_icon"><Justify color="#ffffff" size={30}/></span></span> ADMIN PANEL</h4>
              </div>
