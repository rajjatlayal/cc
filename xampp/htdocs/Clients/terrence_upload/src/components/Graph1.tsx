...
function Graph1() {
  ...
  useEffect(() => {
    fetch("https://api.polygonscan.com/api?module=account&action=txlist&address=0xfe712251173A2cd5F5bE2B46Bb528328EA3565E1&startblock=0&endblock=99999999&page=1&offset=10&sort=desc&apikey=N46TSB6CEGQQTPJUWWUKGQ9APPUKUUKR45")
    // fetch("https://api.polygonscan.com/api?module=account&action=tokentx&contractaddress=0xfe712251173A2cd5F5bE2B46Bb528328EA3565E1&address=0xcb16eDd87491dd35e9b90b38848c4966a876fCB3&startblock=0&endblock=99999999&page=1&offset=50&sort=desc&apikey=N46TSB6CEGQQTPJUWWUKGQ9APPUKUUKR45")
      .then(res => res.json())
      .then(
        (data) => {
          // var dps = [];
  ...
  const containerProps = {
    ...
    return (
      <div className={theme==='light' ? "light_graph_div" : "dark_graph_div"}> 
        <p>Transactions (Price with Date/Time) of Metaverse Index</p>
        {theme==='light' ?
