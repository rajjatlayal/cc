...
import { Lock,PencilFill} from 'react-bootstrap-icons';
import { admin_table_id } from './../Path.js';
// import { DataStore } from '@aws-amplify/datastore';
// import {Admin,WatchList} from './../models';
...
function Settings()  {
    ...
    const Password_data=async (event)=>{
        ...
        //     new WatchList({
        //         "collection_name": "murixhaus",
        //         "price": "1",
        //         "user_id": "f5051ff5-83ab-4a04-ba63-f5c31dcd8ff8"
        //     })
        // );
        // if(handleValidation()){	
        //     setLoader(true);
        ...
        //     if(md5(old_password.current.value)!==OldPassword){
        //         setErrors('Old password is not correct');		   
        //     }else{
        //         setErrors('');	
        //         await DataStore.save(
        //             Admin.copyOf(original, updated => {
        //             updated.password=`${md5(new_password.current.value)}`;
        //             })
        //         ).then((data)=>{
        //             setLoader(false);
        //             setOpacity('');
    ...
    return (
        ...
        <div className="row main_row" style={{width:"100%",margin:"0",height:"100vh"}}>
            ...
            <div className="col-xl-10 col-lg-9 col-md-9" style={{paddingLeft:"0",paddingRight:"0"}}>
                {/* <h3 className="page_head"><span><Lock size={24} color="#4B4B4B" /></span> Change Password</h3> */}
