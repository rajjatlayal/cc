...
function Winners()  {
    ...
    const data = React.useMemo(
      () => [
        {
          col1: '0xcb16eDd87491dd9b4365fdgfd76fCB3',col2:'dsdf54353FD',col3: '20 August 2022',col4:<p className="action_btns"><Link to='/admin/update_whitelist'><span className="edit_icon"  title="Edit"><PencilSquare size={18} color="#ffffff" /></span></Link> <span className="del_icon" title="Delete"><TrashFill size={18} color="#ffffff" /></span></p>
        },
        {
          col1: '0xcb1f554xcxfd5e9b4365fdgfd76fCB3',col2:'345fgdsgfGT',col3: '21 August 2022',col4:<p className="action_btns"><Link to='/admin/update_whitelist'><span className="edit_icon"  title="Edit"><PencilSquare size={18} color="#ffffff" /></span></Link> <span className="del_icon" title="Delete"><TrashFill size={18} color="#ffffff" /></span></p>
        },
        {
          col1: '0xcb16eDd83454fdgfd65fdgfd76fCB3',col2:'dsfds43534F',col3: '22 August 2022',col4:<p className="action_btns"><Link to='/admin/update_whitelist'><span className="edit_icon"  title="Edit"><PencilSquare size={18} color="#ffffff" /></span></Link> <span className="del_icon" title="Delete"><TrashFill size={18} color="#ffffff" /></span></p>
        },
        {
          col1: '0xcb16eD34543de9b4365fdgfd76fCB3',col2:'fds345435vH',col3: '23 August 2022',col4:<p className="action_btns"><Link to='/admin/update_whitelist'><span className="edit_icon"  title="Edit"><PencilSquare size={18} color="#ffffff" /></span></Link> <span className="del_icon" title="Delete"><TrashFill size={18} color="#ffffff" /></span></p>
        },
      ],
      []
    )
                    ...
                    <div className="page_head">
                        <div className="row" style={{width:"100%",margin:"0"}}>
                            <div className="col-xl-6">
                                <h3 className="admin_faq_heading"><span><QuestionCircle size={24} color="#000000" /></span> Winner List</h3>
                            </div>
                        </div>
                    </div>
