...
function Perks()  {
    ...
    const data = React.useMemo(
      () => [
        {
          col1: 'perk1',col2: "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s.",col3: '20 August 2022',col4:<p className="action_btns"><Link to='/admin/update_perk'><span className="edit_icon"  title="Edit"><PencilSquare size={18} color="#ffffff" /></span></Link> <span className="del_icon" title="Delete"><TrashFill size={18} color="#ffffff" /></span></p>
        },
        {
          col1: 'perk2',col2: "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s.",col3: '20 August 2022',col4:<p className="action_btns"><Link to='/admin/update_perk'><span className="edit_icon"  title="Edit"><PencilSquare size={18} color="#ffffff" /></span></Link> <span className="del_icon" title="Delete"><TrashFill size={18} color="#ffffff" /></span></p>
        },
        {
          col1: 'perk3',col2: "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s.",col3: '20 August 2022',col4:<p className="action_btns"><Link to='/admin/update_perk'><span className="edit_icon"  title="Edit"><PencilSquare size={18} color="#ffffff" /></span></Link> <span className="del_icon" title="Delete"><TrashFill size={18} color="#ffffff" /></span></p>
        },
        {
          col1: 'perk4',col2: "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s.",col3: '20 August 2022',col4:<p className="action_btns"><Link to='/admin/update_perk'><span className="edit_icon"  title="Edit"><PencilSquare size={18} color="#ffffff" /></span></Link> <span className="del_icon" title="Delete"><TrashFill size={18} color="#ffffff" /></span></p>
        },
      ],
      []
    )
                    ...
                    <div className="page_head">
                        <div className="row" style={{width:"100%",margin:"0"}}>
                            <div className="col-xl-6">
                                <h3 className="admin_faq_heading"><span><QuestionCircle size={24} color="#000000" /></span> Membership Perks</h3>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="admin_table_outer_div">
                      <div className="admin_tables">
                          <div className="admin_head_right col-xl-12">
                              <Link to='/admin/create_perk'><button className="form_btn">Add New</button></Link>
                          </div><br/>
